...
describe('Testes de integração da rota DELETE /administradores/alunos/:idAluno', () => {
  ...
  describe('Testes de Validação da requisição', () => {
    test('Deve retornar 406 informando que o aluno é inexistente', async () => {
      const response = await HELPER_ADMINS.removerAluno(mongoid(), tokenAdmin)
  ...
  describe('Testes de segurança', () => {
    test('Deve retornar 403 informando que o token não foi fornecido', async () => {
      ...
      const response = await HELPER_ADMINS.removerAluno(aluno._id, '')
    ...
    test('Deve retornar 403 informando que o acesso não é autorizado quando um aluno acessa', async () => {
      ...
      const response = await HELPER_ADMINS.removerAluno(aluno._id, tokenAluno)
    ...
    test('Deve retornar 403 informando que o acesso não é autorizado quando um tutor acessa', async () => {
      ...
      const response = await HELPER_ADMINS.removerAluno(aluno._id, tokenTutor)
  ...
  describe('Removendo um aluno com sucesso', () => {
    test('Deve retornar status 200 "ok"', async () => {
      ...
      const response = await HELPER_ADMINS.removerAluno(aluno._id, tokenAdmin)
